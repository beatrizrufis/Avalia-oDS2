...
namespace ProjetoAgoraVai.Controllers
{
    public class PlacarsController : Controller
    {
        ...
        public PlacarsController(Contexto context)
        {
            _context = context;
        }
        ...
        {
            var contexto = _context.placars.Include(p => p.Jogador).OrderByDescending(p => p.Pontos).Take(10);
        ...
        {
            ViewData["JogadorId"] = new SelectList(_context.jogaadors, "JogadorId", "Nacionalidade");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PlacarId,JogadorId,Pontos,Data")] Placar placar)
        {
            ...
            ViewData["JogadorId"] = new SelectList(_context.jogaadors, "JogadorId", "Nacionalidade", placar.JogadorId);
            return View(placar);
        }
